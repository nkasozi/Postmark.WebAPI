...
{
    public class ApiValidationActorTests:BaseTest
    {
        ...
        public void Given_ValidSingleEmail_ExpectSuccess()
        {
            ...
            IValidationRule unsubscribeRule;
            IEmailValidationRulesEvaluator rulesEvaluator = new EmailValidationRulesEvaluator();

            var actor = Sys.ActorOf(ApiValidationActor.Create(rulesEvaluator));

            var ID = "1234";
            var request = new ApiValidationActor.ValidateEmailRequestCmd
            {
        ...
        //        emailResult.Message.Should().NotBeNullOrEmpty();
        //        emailResult.Message.Should().Be(UnsubscribeRule.USER_ALREADY_UNSUBSCRIBED_MESSAGE);
        //        emailResult.To.Should().NotBeNullOrEmpty();
        //        emailResult.MessageID.Should().NotBeNullOrEmpty();
        //        emailResult.UniqueEmailID.Should().NotBeNullOrEmpty();
        //        Assert.Contains(testEmailList, x => x.UniqueEmailID == emailResult.UniqueEmailID);
        ...
        ////test bulk with mixture of valid and invalid
        //[Fact()]
        ...
        //    answer.Results.Find(i => i.UniqueEmailID == ID).Message.Should().Be(UnsubscribeRule.USER_ALREADY_UNSUBSCRIBED_MESSAGE);
        ...
        //    answer.Results.Find(i => i.UniqueEmailID == ID3).Message.Should().Be(UnsubscribeRule.USER_ALREADY_UNSUBSCRIBED_MESSAGE);
